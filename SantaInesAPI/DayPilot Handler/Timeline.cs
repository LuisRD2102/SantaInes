...
namespace Project.DayPilot_Handler
{
    public class Timeline
    {
        ...
        public static int MorningShiftStarts = 7;
        public static int MorningShiftEnds = 13;

        public static int AfternoonShiftStarts = 13;
        public static int AfternoonShiftEnds = 21;


        public static List<Cita> GenerateSlots(DateTime start, DateTime end, string scale)
        {
