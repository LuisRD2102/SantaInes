...
{
    public partial class Fksdirecciones : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Municipios_Estados_id_estado",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_parroquia = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    id_municipio = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Parroquias", x => x.id_parroquia);
                    table.ForeignKey(
                        name: "FK_Parroquias_Municipios_id_municipio",
            ...
            migrationBuilder.InsertData(
                table: "Municipios",
                columns: new[] { "id_municipio", "id_estado", "municipio" },
                values: new object[,]
                {
                    { 1, 1, "Alto Orinoco" },
                    { 2, 1, "Atabapo" },
            ...
            migrationBuilder.InsertData(
                table: "Parroquias",
                columns: new[] { "id_parroquia", "id_municipio", "parroquia" },
                values: new object[,]
                {
                    { 1, 1, "Alto Orinoco" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Municipios_id_estado",
                table: "Municipios",
                column: "id_estado");

            migrationBuilder.CreateIndex(
                name: "IX_Parroquias_id_municipio",
                table: "Parroquias",
                column: "id_municipio");

            migrationBuilder.AddForeignKey(
                name: "FK_Direccion_Estados_id_estado",
                table: "Direccion",
                column: "id_estado",
                principalTable: "Estados",
                principalColumn: "id_estado");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Direccion_Municipios_id_municipio",
                table: "Direccion",
                column: "id_municipio",
                principalTable: "Municipios",
                principalColumn: "id_municipio");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Direccion_Parroquias_id_parroquia",
                table: "Direccion",
                column: "id_parroquia",
                principalTable: "Parroquias",
                principalColumn: "id_parroquia");
        }
