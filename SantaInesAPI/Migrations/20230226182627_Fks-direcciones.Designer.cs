...
namespace SantaInesAPI.Migrations
{
    ...
    [Migration("20230226182627_Fks-direcciones")]
    partial class Fksdirecciones
    {
            ...
            modelBuilder.Entity("SantaInesAPI.Persistence.Entity.Direccion", b =>
                {
                    ...
                    b.HasIndex("id_estado")
                        .IsUnique()
                        .HasFilter("[id_estado] IS NOT NULL");

                    b.HasIndex("id_municipio")
                        .IsUnique()
                        .HasFilter("[id_municipio] IS NOT NULL");

                    b.HasIndex("id_parroquia")
                        .IsUnique()
                        .HasFilter("[id_parroquia] IS NOT NULL");
            ...
            modelBuilder.Entity("SantaInesAPI.Persistence.Entity.Direccion", b =>
                {
                    b.HasOne("SantaInesAPI.Persistence.Entity.Estado", "Estado")
                        .WithOne("Direccion")
                        .HasForeignKey("SantaInesAPI.Persistence.Entity.Direccion", "id_estado");

                    b.HasOne("SantaInesAPI.Persistence.Entity.Municipio", "Municipio")
                        .WithOne("Direccion")
                        .HasForeignKey("SantaInesAPI.Persistence.Entity.Direccion", "id_municipio");

                    b.HasOne("SantaInesAPI.Persistence.Entity.Parroquia", "Parroquia")
                        .WithOne("Direccion")
                        .HasForeignKey("SantaInesAPI.Persistence.Entity.Direccion", "id_parroquia");
